...
public class PropertyDevConfig {
	...
	public String toString() {
		return "PropertyDevConfig [sslKeyStore=" + sslKeyStore + ", sslKeyStoreType=" + sslKeyStoreType
				+ ", sslKeyStorePwd=" + sslKeyStorePwd + ", sslKeyAlias=" + sslKeyAlias + ", sslTrustStore="
				+ sslTrustStore + ", hibernateDialect=" + hibernateDialect + ", datasourceUrl=" + datasourceUrl
				+ ", datasourceUser=" + datasourceUser + ", datasourcePwd=" + datasourcePwd + ", jpaShowSql="
				+ jpaShowSql + ", jpaHibernateDDLauto=" + jpaHibernateDDLauto + ", jpaDatabasePlatform="
				+ jpaDatabasePlatform + "]";
	}
