...
@Entity
@Table(name = _EntityNames.SHIPPER)
public class Shipper implements _Entity {
	...
	public String toString() {
		return "Shipper [id=" + id + ", company=" + company + ", lastName=" + lastName + ", firstName=" + firstName
				...
				+ notes + ", webSiteUrl=" + webSiteUrl + ", webSiteTitle=" + webSiteTitle + ", portraitPath="
